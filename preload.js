...
contextBridge.exposeInMainWorld('api', {
  ...
  selfbot: {
    ...
    getAutoReleaseChannels:   ()    => ipcRenderer.invoke('selfbot:getAutoReleaseChannels'),
    addAutoReleaseChannel:    (id)  => ipcRenderer.invoke('selfbot:addAutoReleaseChannel', id),
    removeAutoReleaseChannel: (id)  => ipcRenderer.invoke('selfbot:removeAutoReleaseChannel', id),
    testAutoRelease:          (id)  => ipcRenderer.invoke('selfbot:testAutoRelease', id),
  },
  ...
  onReleasesRefresh: cb => ipcRenderer.on('releases:refresh',    (_, d) => cb(d)),
  proxies: {
